function [hldr,badchan] = AbValRefereeCAMBRIDGE(data,ChannelCount,Bloc)
%% make a data matrix
...
% Because we recorded all 64 channels even though there are only 16 per
% bank. Let's keep only the channls with signals. Here's a list:
signals = [3:8,13:14,20,23:29];
