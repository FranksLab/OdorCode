...
CVHv = CVHv(CONDv == 1 | CONDv == 3);
CVWv = CVWv(CONDv == 1 | CONDv == 3);
GroupNamev = GroupNamev(CONDv == 1 | CONDv == 3);

%%
ygb = cbrewer('div','RdYlBu',16,'pchip');
ygb = ygb([3,5,13,16],:);
ygb = ([0 0 0; 1 0 0]);
scatterhist(CVHv,CVWv,'Group',GroupNamev,'Marker','.','MarkerSize',30,'Color',ygb,'Location','SouthWest','LineStyle',{'-';'-'})
% 
