function [SpikeTimes,PREX,Fs,t,BreathStats,tWarp,warpFmatrix,tFmatrix] = GatherInfo1_NoValves(CLUfile)
...
[SpikeTimes] = CreateSpikeTimes(FilesKK.SPK,FilesKK.KWIK,Fs,tWarpLinear);
