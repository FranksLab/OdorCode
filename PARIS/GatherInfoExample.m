...
% %%
CLUfile = 'Z:\CLU files\08-Aug-2014-005.clu.1';
...
scatter(Concs+.1*odor,100*MUASummary.SpikesDuringOdor(VS)./MUASummary.SpikesDuringOdor(5),'o','filled');
...
scatter(Concs+.1*odor,100*MUASummary.SpikesFirstCycle(VS)./MUASummary.SpikesFirstCycle(5),'o','filled');
...
scatter(Concs+.1*odor,100*MUASummary.AS.PeakResponse(VS)./MUASummary.AS.PeakResponse(5),'o','filled');
ylim([0 200]); xlim([0 5]);
ylabel('MUA Spike Rate')
xlabel('log(Conc)')
set(gca,'XTick',[1,2,3,4],'XTickLabel',{[];-2;-1;0})
...
a = cat(1,ExptFullData.ValveSpikes.HistAligned{1,cc(i)});
imagesc(Edges,[1:40/12:40],a)
xlim([-1 3])
colormap(kray)
hold on
axis xy
...
htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{1,cc(i)});
plot(Edges,htplot,'k')
% hold on
...
a = cat(1,ExptFullData.ValveSpikes.HistAligned{4,cc(i)});
imagesc(Edges,[1:40/12:40],a)
xlim([-1 3])
colormap(kray)
hold on
...
ygb = cbrewer('seq','YlGnBu',6,'pchip');
set(gca,'ColorOrder',ygb(6,:));
% set(gca,'NextPlot','replacechildren')
htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{4,cc(i)});
plot(Edges,htplot)
% hold on
% plot(Edges,ExptFullData.ValveSpikes.HistWarpSmoothRate{1,cc(1)},'k:')
ylim([0 40])
...
a = cat(1,ExptFullData.ValveSpikes.HistAligned{8,cc(i)});
imagesc(Edges,[1:40/12:40],a)
xlim([-1 3])
colormap(kray)
hold on
...
set(gca,'ColorOrder',ygb(6,:));
% set(gca,'NextPlot','replacechildren')
htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{8,cc(i)});
plot(Edges,htplot)
% hold on
% plot(Edges,ExptFullData.ValveSpikes.HistWarpSmoothRate{1,cc(1)},'k:')
ylim([0 40])
...
% set(gca,'ColorOrder',ygb(4:6,:));
% set(gca,'NextPlot','replacechildren')
% htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{1,cc(4)});
% plot(Edges,htplot,'k')
% % hold on
% % plot(Edges,ExptFullData.ValveSpikes.HistWarpSmoothRate{1,cc(1)},'k:')
% % ylim([0 40])
...
% set(gca,'ColorOrder',ygb(6,:));
% set(gca,'NextPlot','replacechildren')
% htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{4,cc(4)});
% plot(Edges,htplot)
% % hold on
% % plot(Edges,ExptFullData.ValveSpikes.HistWarpSmoothRate{1,cc(1)},'k:')
% % ylim([0 40])
...
% set(gca,'ColorOrder',ygb(6,:));
% set(gca,'NextPlot','replacechildren')
% htplot = cat(2,ExptFullData.ValveSpikes.HistAlignSmoothRate{8,cc(4)});
% plot(Edges,htplot)
% % hold on
% % plot(Edges,ExptFullData.ValveSpikes.HistWarpSmoothRate{1,cc(1)},'k:')
% % ylim([0 40])
...
% 
% hold on
% a = cat(1,ExptFullData.ValveSpikes.HistWarped{8,cc(1)});
% imagesc(Edges,[1:40/12:40],a)
% xlim([-5 10])
% colormap(flip(gray))
% 
